...
(function(window) {
  ...
  soundManager.setup({
    ...
    url: base_url + '/assets/front/swf/'
    //url : baseUrl('medias/swf/'),
  });
...
*/
	  ...
	  function setTitle(item) {
	    ...
	    if (dom.playlistTarget.getElementsByTagName('li')[0].scrollWidth > dom.playlistTarget.offsetWidth) {
	      // this item can use <marquee>, in fact.
	       dom.playlistTarget.innerHTML = '<ul class="sm2-playlist-bd"><li title="' + item.innerHTML + '" class="sm2-active-file">' + item.innerHTML + '</li></ul>';
	    }
	  ...
	  function handleClick(e) {
	    ...
	    if (target && target.nodeName) {
	      ...
	      if (targetNodeName === 'a') {
            ...
            var $parent = $target.closest('.sm2-bar-ui');*/
            ...
            /*if ( ! $parent.hasClass('playing') || ! $parent.hasClass('pausing') ) {
                alert('xxxxx');
                /*soundManager.stopAll();
                $('.sm2-bar-ui').not($parent).removeClass('playing').removeClass('pausing');
            }*/
	  ...
	  actions = {
	    ...
	    play: function(e) {
          ...
          var currentState = soundObject.playState;
          var $players = $(playerSelector);
          var $parent = $(target).closest(playerSelector);
          var totalPlayer = $players.length;
          var $playing = $(playerSelector + '.playing');

          var playingLength = $playing.length;
          //var $started = $playing || $pla


          /*if (playingLength >= 1 && currentState === 0) {
            soundManager.pauseAll();
